...
| Parameter / Metric | 🌐 Arc Mainnet (`mainnet_agent.py`) | 🧪 Arc Testnet (`agent_testnet.py`) |
| :--- | :--- | :--- |
...
nohup python agent_testnet.py >> agent_history_logs.txt 2>&1 &
```
...
* Copy your raw code directly from GitHub (`mainnet_agent.py` or `agent_testnet.py`).
